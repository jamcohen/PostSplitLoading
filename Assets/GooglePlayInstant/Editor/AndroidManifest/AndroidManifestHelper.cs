...
namespace GooglePlayInstant.Editor.AndroidManifest
{
    ...
    public static class AndroidManifestHelper
    {
        ...
        public static XDocument CreateFeatureModule(string packageName, string featureName, bool isInstant = true)
        {
            return new XDocument(new XElement(
                Manifest,
                new XAttribute(AndroidXmlns, XNamespace.Get(AndroidNamespaceUrl)),
                ...
                new XElement(DistributionModuleXName,
                    ...
                    new XAttribute(DistributionInstantXName, isInstant),
                    new XAttribute(XName.Get("onDemand", DistributionNamespaceUrl), true),
                    new XAttribute(XName.Get("title", DistributionNamespaceUrl), "@string/app_name"),
