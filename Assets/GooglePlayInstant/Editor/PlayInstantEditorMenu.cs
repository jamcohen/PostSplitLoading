...
namespace GooglePlayInstant.Editor
{
    ...
    public static class PlayInstantEditorMenu
    {
        ...
        [MenuItem(PlayInstant + "Run Android App Bundle...", false, 301)]
        private static void RunAndroidAppBundle()
        {
            AppBundleRunner.BuildAndRun();
        }

        [MenuItem(PlayInstant + "Build for Play Console...", false, 302)]
        private static void BuildForPlayConsole()
        {
            PlayInstantPublisher.Build();
        }

        [MenuItem(PlayInstant + "Build and Run #%r", false, 303)]
