...
namespace GooglePlayInstant.Tests.Editor
{
    ...
    public class AndroidBuildToolsTests
    {
        ...
        [Test]
        public void TestIsAtLeastO()
        {
            Assert.IsTrue(GooglePlayInstantUtils.IsAtLeastO("API-3000"));
            Assert.IsTrue(GooglePlayInstantUtils.IsAtLeastO("API-27"));
            Assert.IsTrue(GooglePlayInstantUtils.IsAtLeastO("OS: Android OS 8.1.0 / API-26"));
            Assert.IsFalse(GooglePlayInstantUtils.IsAtLeastO("OS: Android OS 8.1.0 / API-25 (OPM4.171019.021.P1/4820305)"));
            Assert.IsFalse(GooglePlayInstantUtils.IsAtLeastO("OS: Android OS 8.1.0 / API-22 (OPM4.171019.021.P1/4820305)"));
        }
